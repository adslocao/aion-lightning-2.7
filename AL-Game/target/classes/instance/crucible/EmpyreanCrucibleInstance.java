...
public class EmpyreanCrucibleInstance extends CrucibleInstance {
	...
	public void onEnterInstance(Player player) {
		...
		CruciblePlayerReward playerReward = getPlayerReward(player);
	...
	public void onDie(Npc npc) {
		...
		switch (npc.getNpcId()) {
			...
			case 217584:
				...
				sp(217585, 1776.4924f, 777.34296f, 469.79108f, (byte) 12, 6000); // to do fix retail coord
				break;
			case 217585:
				sendEventPacket(StageType.START_STAGE_7_ROUND_5, 2000);
				sp(217587, 1781.4971f, 788.09814f, 469.3501f, (byte) 32, 6000); // to do fix retail coord
				break;
			case 217587:
	...
	public void doReward(Player player) {
		...
		if (!playerReward.isRewarded()) {
			...
			TeleportService.teleportTo(player, mapId, player.getInstanceId(), 381.41684f, 346.78162f, 96.74763f, (byte) 43, 3000, true);
		}
	...
	public boolean onDie(final Player player, Creature lastAttacker) {
		...
		getPlayerReward(player).setSpawnPosition(place);
		return true;
	}
	...
	public boolean onReviveEvent(Player player) {
		...
		switch (getPlayerReward(player).getSpawnPosition()) {
			case 1:
	...
	public void onLeaveInstance(Player player) {
		...
		getPlayerReward(player).setPlayerLeave();
	}
