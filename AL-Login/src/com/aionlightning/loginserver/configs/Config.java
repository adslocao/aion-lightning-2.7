...
public class Config {
	...
	/**
	 * Enable\Disable Server Age Limit
	 */
	@Property(key = "loginserver.server.age.limit.enable", defaultValue = "false")
	public static boolean AGE_LIMIT_ENABLE;
	
	/**
	 * Set the Age for Server Age Limit
	 */
	@Property(key = "loginserver.server.age.limit.level", defaultValue = "16")
	public static int AGE_LIMIT_LEVEL;
