 ...
 */
package com.aionlightning.commons.scripting;
...
public interface ScriptContext {
	 ...
	 * After compilation static methods marked with {@link com.aionlightning.commons.scripting.metadata.OnClassLoad} are invoked
	 */
	public void init();

	/**
	 * Notifies all script classes that they must save their data and release resources to prevent memory leaks. It's done
	 * via static methods with {@link com.aionlightning.commons.scripting.metadata.OnClassUnload} annotation
	 */
	 ...
	 * @see com.aionlightning.commons.scripting.classlistener.AggregatedClassListener
	 * @see com.aionlightning.commons.scripting.classlistener.ScheduledTaskClassListener
	 */
