...
import com.aionlightning.commons.callbacks.CallbackPriority;
...
public class CallbacksUtil {
	 ...
	 * Method checks if callback is instance of {@link com.aionlightning.commons.callbacks.CallbackPriority}, and returns
	 * <p/>
	 * <pre>
	 * {@link com.aionlightning.commons.callbacks.CallbackPriority#DEFAULT_PRIORITY} - {@link com.aionlightning.commons.callbacks.CallbackPriority#getPriority()}
	 * </pre>
	 * <p/>
	 * .<br>
	 * If callback is not instance of CallbackPriority then it returns {@link com.aionlightning.commons.callbacks.CallbackPriority#DEFAULT_PRIORITY}
	 *
