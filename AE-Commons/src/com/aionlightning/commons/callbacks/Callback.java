...
public interface Callback<T> {
	...
	/**
	 * Returns base class that will be used as callback identificator.<br> {@link com.aionlightning.commons.callbacks.metadata.ObjectCallback#value()} should contain
